...
#    ifndef PIMORONI_TRACKBALL_USE_FLOAT
                        ...
                        uint16_t x_amount = (mouse_report.x * speed_modifier * multiplier) >> 8;
                        uint16_t y_amount = (mouse_report.y * speed_modifier * multiplier) >> 8;
...
#    else
                        ...
                        mouse_report.x = CONSTRAIN_HID_XY(mouse_report.x * speed_modifier * multiplier);
                        mouse_report.y = CONSTRAIN_HID_XY(mouse_report.y * speed_modifier * multiplier);
